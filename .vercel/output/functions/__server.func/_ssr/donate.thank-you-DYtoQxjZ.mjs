...
//#region node_modules/.nitro/vite/services/ssr/assets/donate.thank-you-DYtoQxjZ.js
var $$splitComponentImporter = () => import("./donate.thank-you-CEz1RTG6.mjs");
var Route = createFileRoute("/donate/thank-you")({
	...
	head: () => ({ meta: [{ title: "Thank you — Sanjeevora" }, {
		name: "robots",
		content: "noindex"
	}] }),
