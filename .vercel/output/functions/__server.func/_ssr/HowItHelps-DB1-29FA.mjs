...
import { C as Heart, F as BookOpen, T as GraduationCap, s as Sparkles } from "../_libs/lucide-react.mjs";
import { t as Reveal } from "./Reveal-C40uCyOa.mjs";
import { t as CAUSES } from "./causes-DygIn_Oh.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/HowItHelps-DB1-29FA.js
...
var TIERS = [
	{
		amount: 1,
		icon: Heart,
		title: "Step 1: Nourish",
		desc: "We begin by ensuring children have access to nutritious meals and essential support."
	},
	{
		amount: 2,
		icon: BookOpen,
		title: "Step 2: Educate",
		desc: "We provide educational resources, mentoring, and learning opportunities to keep children in school."
	},
	{
		amount: 3,
		icon: Sparkles,
		title: "Step 3: Empower",
		desc: "Children develop confidence, leadership skills, digital literacy, and practical knowledge."
	},
	{
		amount: 4,
		icon: GraduationCap,
		title: "Step 4: Build Futures",
		desc: "Young adults receive career guidance, skill training, and opportunities that help them become independent and successful."
	}
];
function HowItHelps() {
