...
export const Route = createFileRoute("/donate/thank-you")({
  ...
  head: () => ({ meta: [{ title: "Thank you — Sanjeevora" }, { name: "robots", content: "noindex" }] }),
  component: ThankYou,
});
      ...
      <section className="gradient-soft py-20">
        <div className="mx-auto max-w-2xl px-4 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <button onClick={() => navigator.share?.({ title: "I donated to Sanjeevora", url: location.origin })} className="inline-flex items-center gap-2 rounded-full border border-border bg-white px-5 py-2.5 text-sm font-semibold"><Share2 className="h-4 w-4" /> Share</button>
          </div>
        </div>
      </section>
    </SiteShell>
